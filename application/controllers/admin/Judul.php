   ...
   $this->load->model('m_judul');
    ...
    public function index($value='')
    {
     $view = array('judul'     =>'Pengaturan',
                   'data'      =>$this->m_judul->view(),);
      $this->load->view('admin/judul/form',$view);
    }
      ...
      public function api_edit($id='', $SQLupdate='')
      {
        ...
        if ($this->form_validation->run() == FALSE) {
          ...
          if ($this->m_judul->update($id, $SQLupdate)) {
            $response = [
              'status' => true,
      ...
      private function berkas($id='')
    {
      ...
      public function api_hapus($id='')
      {
        if (empty($id)) {
          ...
          $data = $this->m_judul->view_id($id)->row_array();
          if ($this->m_judul->delete($id)) {
            unlink('./themes/foto_logo/'.$data['foto_logo']);
            $response = [
              'status' => true,
