...
<div class="table-responsive">
            ...
            <tr>
                ...
                <td>
                    <a href="" class="btn btn-warning" data-toggle="modal"
                        data-target="#edit<?= $admin['id_pengguna'] ?>"><i class="fa fa-edit"></i> </a>
                </td>
            </tr>
            <?php $no++; endforeach; ?>
        </tbody>
    ...
    <div class="modal fade" id="edit<?= $admin['id_pengguna'] ?>" tabindex="-1" role="dialog"
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="username" class="form-control"
                                            value="<?= $admin['username'] ?>" required=""></td>
                                </tr>
                                <tr>
                                    <th>Password</th>
