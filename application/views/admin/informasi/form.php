    ...
    <table id="example" class="table table-bordered  table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="<?= base_url('themes/file_informasi/'.$informasi['file_informasi']) ?>" width="120px">
                ...
                <div class="modal-body table-responsive">
                    <table class="table table-bordered table-striped">
                        <form id="edit" method="post">
                            ...
                            <tr>
                                <td>
                                    <input type="text" name="id_informasi"
                                        value="<?= $informasi['id_informasi'] ?>" class="form-control" readonly>
                                </td>
                            </tr>
                            <tr>
                                <th class="">Judul</th>
