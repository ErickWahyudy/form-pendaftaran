...
<div class="table-responsive">
                ...
                <div class="modal-body table-responsive">
                    <table class="table table-bordered table-striped">
                        <form id="edit" method="post">
                            ...
                            <tr>
                                <td>
                                    <input type="text" value="<?= $panitia['password'] ?>" class="form-control" readonly>
    ...
    <script>
        ...
        $('#add').submit(function (e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('admin/panitia/api_add') ?>",
                type: "POST",
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/panitia/api_edit/') ?>" + form_data.get('id_panitia'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
        ...
        swal({
            ...
            if (result.value) { // Only delete the data if the user clicked on the confirm button
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('admin/panitia/api_hapus/') ?>" + id_panitia,
                    dataType: "json",
                }).done(function() {
                    swal({
                        title: "Berhasil",
