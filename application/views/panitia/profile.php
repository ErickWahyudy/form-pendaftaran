        ...
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                ...
                <form id="edit" method="post">
                    <input type="hidden" name="id_panitia" value="<?= $id_panitia ?>"class="form-control" readonly>
                            <tr>
                                <th>Nama</th>
                            </tr>
                            <tr>
...
<script>
    ...
    $(document).on('submit', '#edit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('panitia/profile/api_edit/') ?>" + form_data.get('id_panitia'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
    ...
    $(document).on('submit', '#gantipassword', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('panitia/profile/api_password/') ?>" + form_data.get('id_panitia'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
            //memanggil swall ketika berhasil
            success: function(data) {
                $('#gantipassword' + form_data.get('id_panitia'));
                swal({
                    title: "Berhasil",
                    text: "Data Berhasil Diubah",
                    type: "success",
