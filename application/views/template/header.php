...
if($this->session->userdata('level') =="Administrator"){
 ...
 $data= $this->db->get_where('pengguna',array('id_pengguna'=>$id))->row_array();
}elseif($this->session->userdata('level') == "Panitia"){
 $id  = $this->session->userdata('id_panitia');
 $data= $this->db->get_where('panitia',array('id_panitia'=>$id))->row_array();
}
?>
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg">
          <marquee>
          <?php  $nama_judul = $this->db->get('judul')->row_array(); ?>
...
<?php if($this->session->userdata('level') == "Administrator"){ ?>
  <li class="">
      ...
      <li><a href="<?= base_url('admin/periode'); ?>"><i class="fa fa-calendar"></i> <span>Tahun Angkatan</span></a></li>
      <li><a href="<?= base_url('admin/peserta'); ?>"><i class="fa fa-users"></i> <span>Data Peserta</span></a></li>
      <li><a href="<?= base_url('admin/panitia'); ?>"><i class="fa fa-user"></i> <span>Data Panitia</span></a></li>
 
      <li class="header">OTHER</li>
      <li><a href="<?= base_url('admin/informasi'); ?>"><i class="fa fa-bullhorn"></i> Layanan Informasi </a></li>
      <li><a href="<?= base_url('email/kirimemail_Panitia'); ?>"><i class="fa fa-envelope"></i> Kirim Email</a></li>
      <li><a href="<?= base_url('admin/judul'); ?>"><i class="fa fa-gear"></i> <span>Pengaturan</span></a></li>
         <li><a href="<?= base_url('admin/user_admin') ?>" class="active"><i class="fa fa-user"></i> Data Admin</a></li>
        </li>

<?php }elseif($this->session->userdata('level') == "Panitia"){ ?>

  <li class="">
          <a href="<?= base_url('panitia/home') ?>">
            <i class="fa fa-dashboard"></i> <span>Dasboard</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green">Home</small>
            </span>
        ...
        <li class="header">OLAH DATA</li>
 <li class="treeview"> 
      <li><a href="<?= base_url('panitia/peserta'); ?>"><i class="fa fa-users"></i> <span>Data Peserta</span></a></li>
      <li><a href="<?= base_url('panitia/panitia'); ?>"><i class="fa fa-user"></i> <span>Data Panitia</span></a></li>
